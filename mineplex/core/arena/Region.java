...
public class Region
{
  ...
  {
    if ((v.getBlockX() >= this._minX) && (v.getBlockX() <= this._maxX) && (v.getBlockY() >= this._minY) && (v.getBlockY() <= this._maxY) && (v.getBlockZ() >= this._minZ) && (v.getBlockZ() <= this._maxZ)) {
  ...
  {
    this._owners = owners;
    Iterator<String> iterator = this._owners.iterator();
    while (iterator.hasNext())
    {
      String ownerName = (String)iterator.next();
  ...
  {
    if ((this._blockPassage.booleanValue()) && (!this._owners.contains(playerName.toLowerCase()))) {
      return Boolean.valueOf(false);
    }
    return Boolean.valueOf(true);
  }
  ...
  {
    if ((this._blockChange.booleanValue()) && (!this._owners.contains(playerName.toLowerCase()))) {
      return Boolean.valueOf(false);
    }
    return Boolean.valueOf(true);
  }
