...
public class PunishRepository
{
  ...
  public void Punish(Callback<String> callback, String target, String category, PunishmentSentence punishment, String reason, double duration, String admin, int severity)
  {
    ...
    new AsyncJsonWebCall(this._webAddress + "PlayerAccount/Punish.php").Execute(String.class, callback, token);
  }
  ...
  public void RemovePunishment(Callback<String> callback, int id, String target, String reason, String admin)
  {
    ...
    token.Reason = reason;
    token.Admin = admin;
    new AsyncJsonWebCall(this._webAddress + "PlayerAccount/RemovePunishment.php").Execute(String.class, callback, token);
  }
  
  public void LoadPunishClient(String target, Callback<PunishClientToken> callback)
  {
    new AsyncJsonWebCall(this._webAddress + "PlayerAccount/GetPunishClient.php").Execute(PunishClientToken.class, callback, target);
  }
  ...
  public void MatchPlayerName(final Callback<List<String>> callback, final String userName)
  {
    Thread asyncThread = new Thread(new Runnable()
    {
      public void run()
      {
        List tokenList = (List)new JsonWebCall(PunishRepository.this._webAddress + "PlayerAccount/GetMatches.php").Execute(new TypeToken() {}.getType(), userName);
  ...
  public void RemoveBan(String name, String reason)
  {
    ...
    token.Target = name;
    token.Reason = reason;
    new JsonWebCall(this._webAddress + "PlayerAccount/RemoveBan.php").Execute(String.class, token);
  }
}
