...
{
  private NautHashMap<Category, List<Punishment>> _punishments = new NautHashMap();
  
  public void AddPunishment(Category category, Punishment punishment)
  {
    if (!this._punishments.containsKey(category)) {
      this._punishments.put(category, new ArrayList());
    }
  ...
  public boolean IsBanned()
  {
    ...
    for (Iterator localIterator1 = this._punishments.values().iterator(); localIterator1.hasNext(); localIterator2.hasNext())
    {
