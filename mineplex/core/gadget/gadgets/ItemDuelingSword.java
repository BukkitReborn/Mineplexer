  ...
  extends ItemGadget
{
  ...
  {
    super(manager, "Dueling Sword", new String[] {C.cWhite + "While active, you are able to fight", C.cWhite + "against other people who are also", C.cWhite + "wielding a dueling sword." }, -1, Material.WOOD_SWORD, (byte)3, 1000L, new Ammo("Dueling Sword", "10 Swords", Material.WOOD_SWORD, (byte)0, new String[] { C.cWhite + "10 Swords to duel with" }, 1000, 10));
  }
  ...
  public void ActivateCustom(Player player)
  {
    ...
    player.getInventory().setItem(this.Manager.getActiveItemSlot(), stack);
