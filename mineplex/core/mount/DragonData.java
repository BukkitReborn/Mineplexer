...
public class DragonData
{
  ...
  public DragonData(DragonMount dragonMount, Player rider)
  {
    ...
    this.Chicken = rider.getWorld().spawn(rider.getLocation(), Chicken.class);
    this.Dragon.setPassenger(this.Chicken);
    
    this.Chicken.setPassenger(this.Rider);
    
    Bukkit.getServer().getScheduler().runTaskLater(this.Host.Manager.getPlugin(), new Runnable()
    {
      public void run()
      {
        DragonData.this.Chicken.setPassenger(DragonData.this.Rider);
      }
    }, 10L);
  }
