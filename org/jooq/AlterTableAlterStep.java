...
public abstract interface AlterTableAlterStep<T>
{
  ...
  public abstract AlterTableFinalStep defaultValue(T paramT);
  
  @Support({SQLDialect.CUBRID, SQLDialect.DERBY, SQLDialect.FIREBIRD, SQLDialect.H2, SQLDialect.HSQLDB, SQLDialect.MARIADB, SQLDialect.MYSQL, SQLDialect.POSTGRES, SQLDialect.SQLITE})
  public abstract AlterTableFinalStep defaultValue(Field<T> paramField);
  ...
  public abstract AlterTableFinalStep set(DataType<?> paramDataType);
}
