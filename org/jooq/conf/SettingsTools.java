...
public final class SettingsTools
{
  ...
  {
    return ((Boolean)StringUtils.defaultIfNull(settings.isUpdatablePrimaryKeys(), Boolean.valueOf(false))).booleanValue();
  }
  
  public static final boolean reflectionCaching(Settings settings)
  {
    return ((Boolean)StringUtils.defaultIfNull(settings.isReflectionCaching(), Boolean.valueOf(true))).booleanValue();
  }
