...
public class DerbyDataType
{
  ...
  public static final DataType<String> ORGAPACHEDERBYCATALOGTYPEDESCRIPTOR = new DefaultDataType(SQLDialect.DERBY, SQLDataType.CLOB, "org.apache.derby.catalog.TypeDescriptor");
  public static final DataType<String> ORGAPACHEDERBYCATALOGINDEXDESCRIPTOR = new DefaultDataType(SQLDialect.DERBY, SQLDataType.CLOB, "org.apache.derby.catalog.IndexDescriptor");
