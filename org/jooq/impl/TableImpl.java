  ...
  extends AbstractTable<R>
{
  ...
  public final void accept(Context<?> ctx)
  {
    ...
    {
      if ((ctx.qualify()) && ((ctx.family() != SQLDialect.POSTGRES) || (this.parameters == null) || (ctx.declareTables())))
      {
  ...
  public boolean equals(Object that)
  {
    ...
    if ((that instanceof TableImpl))
    {
      ...
      return (StringUtils.equals(getSchema(), other.getSchema())) && (StringUtils.equals(getName(), other.getName())) && (Arrays.equals(this.parameters, other.parameters));
    }
