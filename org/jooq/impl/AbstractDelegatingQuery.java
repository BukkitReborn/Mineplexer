...
abstract class AbstractDelegatingQuery<Q extends Query>
  ...
  implements Query
{
  ...
  {
    if ((this.delegate instanceof AttachableInternal)) {
      return ((AttachableInternal)this.delegate).configuration();
    }
